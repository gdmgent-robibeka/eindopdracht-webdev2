<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Dashboard / NewsItems / Edit / ' . $activeLocale ) }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto p-6">
            <div class="bg-white shadow-sm sm:rounded-lg p-10">
                <form class="w-full" method="POST" accept="route('dashboard.news.editContent')">
                    @csrf
                    ...
                    <div class="md:flex mb-6">
                        ...
                        <div class="md:w-2/3">
                            <textarea class="wysiwyg" id="intro" name="intro">{!! $content->intro !!}</textarea>
                        </div>
                    </div>
